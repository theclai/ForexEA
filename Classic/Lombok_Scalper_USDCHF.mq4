...
//#import "GPSForexRobotUSDCHF.dll"
////   int GPSForexRobot(double& a0[], string a1, string a2, int a3, int a4);
//   int GetGMT();
//#import

extern string GPS_Forex_Robot_USDCHF = " ";
/*
...
int init() {
   ...
   if (StringSubstr(Symbol(), 0, 6) != "USDCHF") {
      SetCommentPrint("WARNING: Use GPS Forex Robot USDCHF only on USDCHF pair.", "comment");
      gi_492 = FALSE;
      return (0);
   }
   if (IsTesting()) {
...
int SetVariables() {
   gda_508[34] = 1.00000000;
   gda_508[35] = 2.00000000;
   gda_508[36] = 88.00000000;
   gda_508[37] = 4.00000000;
   gda_508[38] = 23.00000000;
   gda_508[39] = 0.00000000;
   gda_508[40] = 0.00000000;
   gda_508[41] = 0.00000000;
   gda_508[42] = 1.00000000;
   gda_508[43] = 1.00000000;
   gda_508[44] = 1.00000000;
   gda_508[45] = 1.00000000;
   gda_508[46] = 0.00000000;
   gda_508[47] = -2.00000000;
   gda_508[48] = 1.00000000;
   gda_508[49] = 220.00000000;
   gda_508[50] = 18.00000000;
   gda_508[51] = 5.00000000;

   if (gda_508[34] == 1.0) gi_160 = TRUE;
   else gi_160 = FALSE;
   gi_164 = gda_508[35];
   gd_172 = gda_508[36];
   gd_180 = gda_508[37];
   gi_188 = gda_508[38];
   gi_192 = gda_508[39];
   if (gda_508[40] == 1.0) gi_196 = TRUE;
   else gi_196 = FALSE;
   if (gda_508[41] == 1.0) gi_200 = TRUE;
   else gi_200 = FALSE;
   if (GMTOffset <= 0) {
      if (gda_508[42] == 1.0) gi_200 = TRUE;
      else gi_200 = FALSE;
   }
   if (gda_508[43] == 1.0) gi_204 = TRUE;
   else gi_204 = FALSE;
   if (gda_508[44] == 1.0) gi_208 = TRUE;
   else gi_208 = FALSE;
   if (gda_508[45] == 1.0) gi_212 = TRUE;
   else gi_212 = FALSE;
   if (GMTOffset <= 0) {
      if (gda_508[46] == 1.0) gi_212 = TRUE;
      else gi_212 = FALSE;
   }
   gi_216 = gda_508[47];
   if (gda_508[48] == 1.0) gi_220 = TRUE;
   else gi_220 = FALSE;
   gd_232 = gda_508[49];
   gd_240 = gda_508[50];
   gd_248 = gda_508[51];
