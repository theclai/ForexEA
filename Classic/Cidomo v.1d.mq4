...
extern string Trading_Setting = "---------- Trading_Setting ----------";
...
double Gda_280[30];
int Gi_284 = 0;
string TradeComment = "Cidomo v.1d";
...
int start() {
   ...
   double indiHigh = iHigh(Symbol(), PERIOD_M1, iHighest(NULL,0,MODE_HIGH,32,1));
   double indiLow = iLow(Symbol(), PERIOD_M1, iLowest(NULL,0,MODE_LOW,32,1));
