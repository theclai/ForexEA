...
//+
//+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
//| WallStreet Forex Robot ver. 3.8.4 FINAL (Pirate Edition)
//| 
...
//| .set из папки sets.
//|
//| Для оптимизации используйте файл for_optimisation_wsfr_3.8.4_final.set. Оптимизацию можно проводить по
...
extern string Name = "WallStreet Forex Robot ver. 3.8.4 FINAL (Pirate Edition)";
...
extern double AutoMM = 0.0; //--- ММ включается если AutoMM > 0. Процент риска. При RecoveryMode = FALSE, менять нужно только это значение.
...
string OpenOrderComment = "WSFR v3.8.4 FINAL";
